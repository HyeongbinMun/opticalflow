...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training',
                 root='/data/dataset/optical/dataset/Sintel',
                 dstype='clean',
                 load_occlusion=False,
                 ):
...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='train',
                 root='/data/dataset/optical/dataset/FlyingChairs_release/data',
                 ):
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None,
                 root='/data/dataset/optical/dataset/FlyingThings3D',
...
class VKITTI2(FlowDataset):
    def __init__(self, aug_params=None,
                 root='/data/dataset/optical/dataset/VKITTI2',
                 ):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training',
                 root='/data/dataset/optical/dataset/KITTI2015/KITTI2015',
                 ):
